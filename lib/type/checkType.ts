 ...
 */
export const isNotANumber = (val: any): val is typeof NaN => objIs(NaN, val);
 ...
 */
export const isInfinity = (val: any): val is typeof Infinity => val === Infinity || val === -Infinity;
 ...
 */
export const checkType = (val: any, skipSpecialNumberCheck: boolean = false): typeof val => {
